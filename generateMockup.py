...
# Read selected sheet
medReadDF = pd.read_excel(fileName, sheet_name=13)
dentReadDF = pd.read_excel(fileName, sheet_name=14)
medTechReadDf = pd.read_excel(fileName, sheet_name=15)
NurseReadDf = pd.read_excel(fileName, sheet_name=16)
# Concat sheet
...
education_group_df = pd.DataFrame(education_group)
education_group_df = education_group_df.assign(**data)
result = education_group_df
print(result)
